...
// [LC-TELE] LC telemetry blob (see audio_pipeline.h LC_TELE_NUM_BYTES); read-only. dev.204: 18 -> 32 bytes
#define DFU_CONTROLLER_SERVICER_RESID_GET_LC_STATE_NUM_VALUES (32)
